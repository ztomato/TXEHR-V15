...
def help():
    helpinfo = """  _________   ________ _    _ _____   __      ____ _____ 
 |__   __\ \ / /  ____| |  | |  __ \  \ \    / /_ | ____|
    | |   \ V /| |__  | |__| | |__) |  \ \  / / | | |__  
    | |    > < |  __| |  __  |  _  /    \ \/ /  | |___ \ 
    | |   / . \| |____| |  | | | \ \     \  /   | |___) |
    |_|  /_/ \_\______|_|  |_|_|  \_\     \/    |_|____/ 
"""
    print(helpinfo)
    print("TXEHR V15".center(100, '*'))
...
def main():
    parser = argparse.ArgumentParser(description='TXEHR V15-UploadFile漏洞单批检测脚本@ztomato')
